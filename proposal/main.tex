...
\begin{itemize}
  \item Steady load: a constant arrival rate of 1,000 tasks/second for the full duration of the run.
  \item Flash crowd: a burst of 5,000 tasks/second followed by a 10-second idle period, repeated in cycles.
  \item Daily ramp: alternating phases on 100 tasks/second and 2,000 tasks/second in repeated cycles.
\end{itemize}
